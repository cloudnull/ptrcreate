...
__appname__ = "ptrcreate"
__description__ = 'Create a PTR Record for a Rackspace Cloud Server.'
__url__ = 'https://github.com/cloudnull/ptrcreate.git'

# The Version Of the Application
__VN__ = '%s' % __version__

# The Version and Information for the application
VINFO = ('PTR Create %(version)s, '
